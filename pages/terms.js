    ...
    <main className="terms-page">
      <div className="content">
        ...
        <p>
          ...
          &quotSite&quot) is comprised of various web pages operated by UP Trade
          Technologies, Incorporated (&quotUP Trade&quot). uptradeit.com is
          ...
          &quotTerms&quot). Your use of uptradeit.com constitutes your agreement
        ...
        <p>
          ...
          misappropriation of your account. UP Trade and its associates reserve
        ...
        <p>
          Once you accept the offer from UP Trade, it will be considered a final
          transaction unless we determine that the physical condition of the
          device is different from the original description that was submitted.
          If this happens, we will provide you an updated offer based on the
          value of the device. If you decline the new offer, we will return your
          device to you at no cost and the transaction will be canceled. If no
          action is taken after four days, we will proceed with the updated
          offer.
        </p>
        ...
        <p>
          ...
          not imply endorsement by UP Trade of the site or any association with
          its operators.
        </p>
        <p>
        ...
        <p>
          ...
          exploit any of the content, in whole or in part, found on the Site. UP
          Trade content is not for resale. Your use of the Site does not entitle
          ...
          without the express written permission of UP Trade and the copyright
          ...
          implied, to the intellectual property of UP Trade or our licensors
        ...
        <p>
          ...
          device(s) have been lost, stolen or damaged before UP Trade receives,
          we will make our best effort to help you find the best solution, but
          UP Trade will not be responsible for any compensation. Up Trade will
          not be held liable for any devices that were improperly packaged. The
          lack of “proper packing” includes but is not limited to an unpadded or
          unsealed box or envelope or not enough padding to keep the electronic
          device(s) secure within the package. The value of any electronic
          device(s) that are inadequately packaged will NOT be reimbursed. If
          you have questions regarding how to package your item please discuss
          your concerns with a local shipping consultant. For all insurance
          claims, you must be able to show proof of purchase and be willing to
          take all the appropriate steps to satisfy the information needed for
          the claim.
        </p>
        ...
        <p>
          ...
          &quotCommunication Services&quot). You agree to use the Communication
        ...
        <p>
          ...
          information or materials, in whole or in part, in UP Trade&apos;s sole
          discretion.
        </p>
        ...
        <p>
          ...
          Service. UP Trade does not control or endorse the content, messages or
          information found in any Communication Service and, therefore, UP
          ...
          authorized UP Trade spokespersons, and their views do not necessarily
          reflect those of UP Trade.
        </p>
        ...
        <h2>
          Materials Provided to uptradeit.com or Posted on Any UP Trade Web Page
        </h2>
        ...
        <p>
          ...
          (collectively &quotSubmissions&quot). However, by posting, uploading,
          inputting, providing or submitting your Submission you are granting UP
          Trade, our affiliated companies and necessary sublicensees permission
        ...
        <p>
          The sale of stolen property violates state, federal, and international
          law, and we may notify law enforcement of any sale of, or attempts to
          sell, stolen, counterfeit, or fraudulent property on our Site. We also
          support the investigation and prosecution of sellers who violate this
          policy, and such listings may be removed, and you may be subject to a
          range of other actions, including limits of your buying and selling
        ...
        <p>
          ...
          ownership rights for all such device(s), (2) all such device(s) shall
          be able to be activated for new service (with the exception of
          device(s) incapable of being activated because it is in a
          nonfunctional or broken condition and is disclosed as such), (3) the
          device(s) and the sale and shipment of such device(s) to UP Trade are
          not stolen, counterfeit, or fraudulent, (4) the device(s) do not
          infringe on third party intellectual property rights, (5) the
          device(s) are free of any liens or encumbrances, including third-party
          software which may not be transferred or for which royalties are due,
          (6) you have removed any security codes that would prevent the use of
          such device(s), and (7) you have discontinued phone, Internet and/or
          any similar service on such device(s) prior to selling it to UP Trade.
          By using UP Trade services, you agree to indemnify UP Trade from all
          claims or losses, including but not limited to attorney fees,
          sustained by UP Trade as a result of any breach of your
          representations and warranties. UP Trade is not responsible for any
          service charges related to your electronic device(s), whether you
          incur such charges before, during or after your use of the services.
        </p>
        ...
        <p>
          The Service is controlled, operated and administered by UP Trade from
          ...
          laws. You agree that you will not use the UP Trade Content accessed
          through uptradeit.com in any country or in any manner prohibited by
        ...
        <p>
          ...
          rules or regulations. UP Trade reserves the right, at its own cost, to
          ...
          cooperate with UP Trade in asserting any available defenses.
        </p>
        <h2>Arbitration</h2>
        <p>
          ...
          agreed upon by the parties. The arbitrator&apos;s award shall be
          ...
          costs and reasonable attorney&apos;s fees. The parties agree to
          arbitrate all disputes and claims in regards to these Terms and
        ...
        <p>
          ...
          EACH&apos;S INDIVIDUAL CAPACITY, AND NOT AS A PLAINTIFF OR CLASS
        ...
        <p>
          ...
          PROVIDED &quotAS IS&quot WITHOUT WARRANTY OR CONDITION OF ANY KIND. UP
          TRADE TECHNOLOGIES, INCORPORATED AND/OR ITS SUPPLIERS HEREBY DISCLAIM
        ...
        <p>
          ...
          UP TRADE TECHNOLOGIES, INCORPORATED AND/OR ITS SUPPLIERS BE LIABLE FOR
          ...
          CONTRACT, TORT, NEGLIGENCE, STRICT LIABILITY OR OTHERWISE, EVEN IF UP
          TRADE TECHNOLOGIES, INCORPORATED OR ANY OF ITS SUPPLIERS HAS BEEN
        ...
        <p>
          UP Trade reserves the right, in its sole discretion, to terminate your
        ...
        <p>
          ...
          contained in this agreement is in derogation of UP Trade&apos;s right
          ...
          to or gathered by UP Trade with respect to such use. If any part of
        ...
        <p>
          ...
          UP Trade with respect to the Site. A printed version of this agreement
        ...
        <p>
          ...
          of the Terms will supersede all previous versions. UP Trade encourages
          you to periodically review the Terms to stay informed of our updates.
        </p>
        <h2>Contact Us</h2>
        <p>
          UP Trade welcomes your questions or comments regarding the Terms: UP
          Trade Technologies, Incorporated 550 S Watters Rd, Suite 276 Allen, TX
          75013 Email Address: support@uptradeit.com
