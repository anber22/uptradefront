      ...
      <main className="terms-page">
        ...
        <div className="content">
          ...
          <p>
            ...
            Trade&apos;s public message boards, this information may be
          ...
          <p>
            ...
            provide these services to UP Trade, and they are required to
          ...
          <p>
            ...
            comply with legal process served on UP Trade or the site; (b)
            protect and defend the rights or property of UP Trade; and/or (c)
            act under exigent circumstances to protect the personal safety of
            users of UP Trade, or the public.
          </p>
          <h2>Tracking User Behavior</h2>
          <p>
            UP Trade may keep track of the websites and pages our users visit
            within UP Trade, in order to determine what UP Trade services are
            the most popular. This data is used to deliver customized content
            and advertising within UP Trade to customers whose behavior
            indicates that they are interested in a particular subject area.
          </p>
          <p>
            UP Trade may use advanced third-party web analytics tools to track
          ...
          <p>
            ...
            you personalize UP Trade pages, or register with UP Trade site or
            services, a cookie helps UP Trade to recall your specific
            ...
            shipping addresses, and so on. When you return to the same UP Trade
            website, the information you previously provided can be retrieved,
            so you can easily use the UP Trade features that you customized.
          </p>
          <p>
            ...
            interactive features of the UP Trade services or websites you visit.
          </p>
          <h2>Links</h2>
          <p>
          ...
          <p>
            ...
            wireless network can be guaranteed to be
          </p>
          <p>
          ...
          <p>
            From time to time, UP Trade may contact you via email for the
            ...
            an email from UP Trade or click on a link therein.
          </p>
          <p>
          ...
          <p>
            UP Trade reserves the right to change this Privacy Policy from time
          ...
          <p>
            UP Trade welcomes your questions or comments regarding this
            Statement of Privacy. If you believe that UP Trade has not adhered
            to this Statement, please contact UP Trade at:
          </p>
          <p>
