    ...
    <main className="terms-page">
      <div className="content">
        ...
        <p>
          ...
          Privacy applies to uptradeit.com and UP Trade Technologies,
          ...
          electronic devices such as mobile phones. site. By using the UP Trade
        ...
        <p>
          ...
          our Site, UP Trade may collect personally identifiable information,
          such as your:
        </p>
        ...
        <li>Phone Number</li>
        <p>
          If you purchase UP Trade&apos;s products and services, we collect
        ...
        <p>
          ...
          identifiable information or personally sensitive data through UP
          Trade&apos;s public message boards, this information may be collected
          and used by others.
        </p>
        <p>
        ...
        <p>
          UP Trade collects and uses your personal information to operate its
          website(s) and deliver the services you have requested.
        </p>
        <p>
          UP Trade may also use your personally identifiable information to
          inform you of other products or services available from UP Trade and
          its affiliates.
        </p>
        <h2>Sharing Information with Third Parties</h2>
        <p>
          UP Trade does not sell, rent or lease its customer lists to third
          parties.
        </p>
        <p>
          UP Trade may share data with trusted partners to help perform
          ...
          these services to UP Trade, and they are required to maintain the
          confidentiality of your information.
        </p>
        <p>
          UP Trade may disclose your personal information, without notice, if
          ...
          legal process served on UP Trade or the site; (b) protect and defend
          the rights or property of UP Trade; and/or (c) act under exigent
          circumstances to protect the personal safety of users of UP Trade, or
          the public.
        </p>
        <h2>Tracking User Behavior</h2>
        <p>
          UP Trade may keep track of the websites and pages our users visit
          within UP Trade, in order to determine what UP Trade services are the
          most popular. This data is used to deliver customized content and
          advertising within UP Trade to customers whose behavior indicates that
          they are interested in a particular subject area.
        </p>
        <p>
          UP Trade may use advanced third-party web analytics tools to track and
          analyze user behavior.
        </p>
        <h2>Automatically Collected Information</h2>
        <p>
          Information about your computer hardware and software may be
          automatically collected by UP Trade. This information can include:
          ...
          provide general statistics regarding use of the UP Trade website.
        </p>
        <h2>Use of Cookies</h2>
        <p>
          The UP Trade website may use &quot;cookies&quot; to help you
        ...
        <p>
          ...
          personalize UP Trade pages, or register with UP Trade site or
          services, a cookie helps UP Trade to recall your specific information
          ...
          and so on. When you return to the same UP Trade website, the
          information you previously provided can be retrieved, so you can
          easily use the UP Trade features that you customized.
        </p>
        <p>
          ...
          features of the UP Trade services or websites you visit.
        </p>
        <h2>Links</h2>
        <p>
        ...
        <p>
          UP Trade secures your personal information from unauthorized access,
          use, or disclosure. UP Trade uses the following methods for this
          purpose:
        </p>
        <li>SSL Protocol</li>
        <p>
        ...
        <p>
          ...
          network can be guaranteed to be
        </p>
        <p>
        ...
        <p>
          UP Trade does not knowingly collect personally identifiable
        ...
        <p>
          From time to time, UP Trade may contact you via email for the purpose
          ...
          Services, we may receive a notification when you open an email from UP
          Trade or click on a link therein.
        </p>
        <p>
          If you would like to stop receiving marketing or promotional
          communications via email from UP Trade, you may opt out of such
          communications by clicking on the UNSUBSCRIBE button.
        </p>
        <h2>Changes to this Statement</h2>
        <p>
          UP Trade reserves the right to change this Privacy Policy from time to
